(function() {
    ...
    */
    ...
    RequestParser.prototype.files = function*() {
        if (!this.request.requestFiles)
            yield* this.request.initFiles();
        return this.request.requestFiles;
    };


    RequestParser.prototype.map = function*(target, entitySchema, whitelist, options, parents) {
    ...
    RequestParser.prototype.map_impl = function*(target, entitySchema, whitelist, options, parents) {
        var changed = false;
    ...
    RequestParser.prototype.setField = function*(obj, fieldName, def, entitySchema, whitelist, options, parents) {
    ...
    RequestParser.prototype.setSimpleType = function*(obj, fieldName, def, entitySchema, whitelist, options, parents) {
        var changed = false;
    ...
    */
    RequestParser.prototype.setArray = function*(obj, fieldName, def, entitySchema, whitelist, options, parents) {
        var changed = false;
    ...
    RequestParser.prototype.setCustomType = function*(obj, fieldName, def, entitySchema, whitelist, options, parents) {
        var changed = false;
    ...
    RequestParser.prototype.parseSimpleType = function(val, fieldName, def, entitySchema) {
        if (val) {
            switch(def.type) {
                case "integer":
                    return parseInt(val);
